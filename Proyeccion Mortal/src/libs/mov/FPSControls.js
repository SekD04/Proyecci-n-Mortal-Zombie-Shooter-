...
THREE.PointerLockControls = function (camera, mass, playerHeight, doubleJump, worldObjects) {
	...
	var onMouseMove = function (event) {
		...
		const sensitivity = 0.002; // Ajusta la sensibilidad aquí
		yawObject.rotation.y -= movementX * sensitivity; // Control de rotación Y (horizontal)
		pitchObject.rotation.x -= movementY * sensitivity; // Control de rotación X (vertical)

		// Limitar rotación en el eje X para evitar que la cámara gire demasiado
